...
Codex uses `AGENTS.md` as the repository entrypoint. The reusable workflow
prompts listed below live in `.codex/skills/` and can be invoked by name during
your Codex session.
...
.codex/
  settings.json                    -- Recommended automation and safety settings
