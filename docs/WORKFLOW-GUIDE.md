...
```
=== Codex Code Game Studios -- Session Context ===
Branch: main
Recent commits:
...
.codex/docs/templates/game-pillars.md
```
...
.codex/docs/templates/game-design-document.md
```

**The `design-docs` rule** (`.codex/rules/design-docs.md`) requires every GDD
...
The `narrative` rule (`.codex/rules/narrative.md`) enforces:
...
.codex/docs/templates/milestone-definition.md
```
...
**Key rule:** The `prototype-code` rule (`.codex/rules/prototype-code.md`)
...
The `test-standards` rule (`.codex/rules/test-standards.md`) enforces:
